...
func (v *TermView) draw() {
	...
	case mvc.UpdateInstalling:
		updateMsg = "surf is updating"
	case mvc.UpdateReady:
		updateMsg = "surf has updated: restart surf for the new version"
	case mvc.UpdateAvailable:
		updateMsg = "new version available at https://app.getocean.io"
	default:
	...
	v.APrintf(termbox.ColorBlue|termbox.AttrBold, 0, 0, "surf")
